...
save_model_dir = 'Dataset/output/model/Bi-LSTM/'
save_prediction_dir = 'Dataset/output/prediction/Bi-LSTM/'
...
class LSTMClassifier(nn.Module):
    ...
    def forward(self, input_tensor):
        ...
        h_0 = Variable(torch.zeros(2, self.batch_size, self.hidden_size)) # Initialize hidden state of the LSTM
        c_0 = Variable(torch.zeros(2, self.batch_size, self.hidden_size)) # Initialize cell state of the LSTM
...
def train_model(dataset_name):
    ...
    loss_dir = 'Dataset/output/loss/Bi-LSTM/'
