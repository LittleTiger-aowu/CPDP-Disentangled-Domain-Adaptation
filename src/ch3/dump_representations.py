...
def main() -> None:
    ...
    source_project_vocab = ckpt.get("source_project_vocab")
    ...
    if source_project_vocab:
        with (outdir / "source_project_vocab.json").open("w", encoding="utf-8") as f:
            json.dump(source_project_vocab, f, indent=2)
